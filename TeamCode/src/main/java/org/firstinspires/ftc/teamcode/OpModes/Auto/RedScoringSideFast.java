...
public class RedScoringSideFast extends AutoOpMode {
    ...
    public static Position SPIKE_LEFT_TURN = new Position(11, -36, 165);
    ...
    public static Position DROP_POSITION_BACKUP_BOARD_L = new Position(44, -28, 180);
        public static Position RED_PILE_1_PREPOSITION = new Position(12, -12, 180);
    public static Position RED_PILE_1_POSITION = new Position(-18, -16, 185);
    ...
    public void runOpMode() {
        ...
        switch (spikeLocation) {   // camer detection value goes herre
            case LEFT:
                ...
                splineTo(RED_PILE_1_PREPOSITION);
                intake.stop();
                drop.goToPosition(0);
