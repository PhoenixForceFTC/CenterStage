...
public class RedScoringSideFastL2RB extends AutoOpMode {
...
//    private right right;
    ...
    //--- Deliver
    public static Position SPIKE_LEFT = new Position(10, -34, 180);

    //--- Drop positions
    public static Position DROP_POSITION_TOUCH_BOARD_L = new Position(48, -30, 180);
    public static Position DROP_POSITION_TOUCH_BOARD_L2 = new Position(49, -30, 180);

    //--- Collection positions
    public static Position RED_PILE_1_PREPOSITION = new Position(12, -60, 180);
    public static Position RED_PILE_1_POSITION = new Position(-36, -60, 185);
